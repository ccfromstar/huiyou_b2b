$(function(){
	...
	$(".tdfooter_1").click(function(){
			if($(this).html()=="我的度假邮轮"){window.location="/mycurise";}
			else if($(this).html()=="邮轮度假目的地"){window.location="/destination";}
			else if($(this).html()=="邮轮公司荟萃"){window.location="/curisecompany";}
			else if($(this).html()=="邮轮度假主题"){window.location="/theme";}
			else if($(this).html()=="邮轮生活分享"){window.location="/share";}
			else if($(this).html()=="邮轮促销信息"){window.location="/sales";}
			else if($(this).html()=="帮助"){window.location="/help";}
	});
    $(".port").hover(function(){
	...
	$(".tdfooter_1").hover(function(){
			...
			if($(this).html()=="我的度假邮轮"){$("#menu").fadeOut();}
				...
				if($(this).html()=="邮轮度假目的地"){
					...
					menulist = "皇家加勒比邮轮;歌诗达邮轮;丽星邮轮;公主邮轮;NCL挪威邮轮;MSC地中海邮轮;更多";
					sid = "V0";
