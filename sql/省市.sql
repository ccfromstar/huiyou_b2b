...
pid int,
PRIMARY KEY (id),
CONSTRAINT FK_CITY_PRO_ID FOREIGN KEY (pid) REFERENCES province (id) ON DELETE NO ACTION ON UPDATE NO ACTION
) 
/*插入各个省的city数据 4个直辖市*/
...
insert into city values(5,'晋city',6);
insert into city values(6,'朔州市',6);
insert into city values(7,'晋中市',6);
insert into city values(8,'运city',6);
...
insert into city values(8,'白city',9);
...
insert into city values(9,'盐city',11);
...
insert into city values(17,'宣city',13);
...
insert into city values(15,'聊city',16);
...
insert into city values(20,'塔city',31);
...
/*查询语句*/
/*select * from 省市 select * from city*/